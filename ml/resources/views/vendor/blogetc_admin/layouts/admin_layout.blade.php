...
<head>
    ...
    <title>Administrador de Noticias - {{ config('app.name', 'Laravel') }}</title>
...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container">
            ...
            Administrador de Noticias de {{ config('app.name', 'Laravel') }} 
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class='nav-item px-2'><a class='nav-link' href='{{route("home")}}'>Ir al Dashboard Monerlend</a></li>

...
@section("content")
    ...
    <p>Puede ver todas las imagnes cargadas aquí.</p>
    ...
    @foreach($uploaded_photos as $uploadedPhoto)
        ...
        <div style='border-radius:15px; border:2px solid #efefef; background : #fefefe; margin: 15px;padding:15px'>
                    <h3>ID de la imagen: {{$uploadedPhoto->id}}: {{$uploadedPhoto->image_title ?? "Foto sin titulo"}}</h3>
                    <h4>
                        <small title='{{$uploadedPhoto->created_at}}'>
                            Actualizada {{$uploadedPhoto->created_at->diffForHumans()}}</small>
                    </h4>
            ...
            <div class='row'>
                    ...
                    <div class='row' style=' margin: 10px; background: #eee; overflow:auto; padding:5px;'>
                        ...
                        <div class='col-md-12 '>
                            ...
                            <p class='text-center'><a
                                        ...
                                        onclick='show_uploaded_file_row("{{$id}}","{{asset(     config("blogetc.blog_upload_dir") . "/". $file['filename'])}}")'>mostrar</span>
                            </p>
                        ...
                        <div class='col-md-6 {{$id}}' style='display:none;'>
                            ...
                            <div style=''>
                                <small class='text-muted'>Etiqueta de la imagen</small>
                                <input type='text' readonly='readonly' class='form-control'
                ...
                <div class='col-md-4'>
                    ...
                    @else
                        ...
                        <div class='alert alert-danger'>No se encontro imagen</div>
                    @endif

...
<div class="form-group">
    <label for="category_category_name">Nombre de categoria</label>
    ...
    <small id="category_category_name_help" class="form-text text-muted">El nombre de la categoria</small>
</div>


<div class="form-group">
    <label for="category_slug">Slug para la categoria</label>
    <input
            maxlength='100'
            pattern="[a-zA-Z0-9-]+"
            type="text"
    ...
    <small id="category_slug_help" class="form-text text-muted">
        El slug puede contener. Letras, números, guiones. por ejemplo
         {{route("blogetc.view_category","")}}/<u><em>este_es_el_slug</em></u>. debe ser único.
...
<div class="form-group">
    <label for="category_description">Descripción de la categoria (opcional)</label>
